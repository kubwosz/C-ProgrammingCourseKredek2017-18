...
namespace JakubWoszczynaZad2
{
    public partial class Technology : Form
    {
        ...
        /// <summary>
        /// Zmienna opisująca maskymalny poziomo procentowy paska progresywnego
        /// </summary>
...
RandomNumber(Int32.Parse(textBoxScreenMin.Text), Int32.Parse(textBoxScreenMax.Text)), checkBoxBluetooth.Checked)
        ...
        /// sprawdza także, czy pola zostały wpełnione poprawnie. Obiekt zostaje dodany do listy.
        /// </summary>
        private void GetTabletInformation()
        {
            try
            {
...
RandomNumber(Int32.Parse(textBoxScreenMin.Text), Int32.Parse(textBoxScreenMax.Text)), checkBoxBluetooth.Checked)
        ...
        /// sprawdza także, czy pola zostały wpełnione poprawnie. Obiekt zostaje dodany do listy.
        /// </summary>
        private void GetLaptopInformation()
        {
            try
            {
...
RandomNumber(Int32.Parse(textBoxScreenMin.Text), Int32.Parse(textBoxScreenMax.Text)), checkBoxBluetooth.Checked)
        ...
        /// sprawdza także, czy pola zostały wpełnione poprawnie. Obiekt zostaje dodany do listy.
        /// </summary>
        private void GetSmartphoneInformation()
        {
            try
            {
